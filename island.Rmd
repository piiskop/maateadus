...
plotOfIceland = ggplot() +
  ...
  # Human activities
  geom_text(data = data.frame(lon = -23.5, lat = 63.8), aes(x = lon, y = lat), family = "EmojiOne", label = "\U1F477", size = 16, vjust = .2, color = "#DC1E35") +
  # Climate
  ...
  # Sources
  geom_text(data = data.frame(lon = -23.8, lat = 64.3), aes(x = lon, y = lat), family = "EmojiOne", label = "\U2668", size = 16, vjust = .2, color = "#DC1E35")
